...
class DoubleDQLearning(Heuristic):
    def __init__(self, project_id, model_id, total_n_episodes, **kwargs):
        ...
        super(DoubleDQLearning, self).get_project_definition()
        super(DoubleDQLearning, self).get_model_template()
        ...
        for experiment_id in self.running_experiments:
            ...
            if status_completed:
                ...
                if self.experiments_failed_counter >= 5:
                    ...
                    if self.episodes_counter % self.target_update == 0:
                        agent.update_target()
    ...
    def generate_experiments(self, action):
        ...
        # Send to the queue
        experiment_ids = super(DoubleDQLearning, self).send_experiments_to_queue(experiments_to_queue)
